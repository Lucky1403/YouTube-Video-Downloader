...
A simple Command-line(CLI) tool to download YouTube videos,playlists and audios, built with Python and yt-dlp. No GUI, no bloat — just run it, paste a link, and you're done.
...
- Downloaded files can be large since the script grabs the highest/requested quality streams and merges them.
